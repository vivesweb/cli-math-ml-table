# cli-math-ml-table. is used for view data structure in format table. Has features oriented to datasets before deep learning process. Anyway you can to use this class to visualize any type of data. It cannot do any calc, only visualize the data in an understandable way.
